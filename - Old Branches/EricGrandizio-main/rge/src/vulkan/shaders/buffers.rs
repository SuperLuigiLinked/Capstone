...
impl Buffers {
    ...
    pub fn new(device: &Device) -> Self {
        ...
        let alloc_size = vertex.mem_reqs.size + index.mem_reqs.size;
        let alloc_type = vertex.mem_reqs.memory_type_bits & index.mem_reqs.memory_type_bits;
        let alloc_props =
        ...
        unsafe {
            ...
            this.index.bind(device, &this.memory, this.vertex.size);
        }
